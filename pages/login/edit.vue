	...
	<view>
		<view class="editForm">
			<u-form :model="form" ref="uForm" :rules="rules">
				<u-form-item label="昵称" :label-width="150" prop="realname">
					<u-input v-model="form.nickName" maxlength='20' placeholder="请输入真实姓名" />
				</u-form-item>
				...
				<u-form-item label="手机号码" :label-width="150" prop="phone">
					<view style="display: flex;">
						...
						<view style="width: 200rpx;text-align: right;">
							<u-button type="default" size="mini" open-type="getPhoneNumber" @getphonenumber="handleGetPhoneNumber">获取手机号码</u-button>
						</view>
					</view>
				</u-form-item>
