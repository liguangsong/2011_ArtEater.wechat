	...
	<view class="myPage">
		...
		<view class="subjectItem" v-if="sub.subject_name!='科技文艺常识'" v-for="(sub) in subjects" @click="handleSubjectClick" :data-item="sub">
			<view class="img">
				...
				<image v-if="sub.subject_name=='艺术概论'" src="https://art-eater.oss-cn-beijing.aliyuncs.com/photo/%E7%BE%8E%E6%9C%AF%E9%89%B4%E8%B5%8F-%E6%A0%87%E9%A2%98%E5%9B%BE1.jpg" mode=""></image>
			</view>
			<view class="progress">
