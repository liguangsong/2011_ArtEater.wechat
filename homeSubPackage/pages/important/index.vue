	...
	<view class="myPage">
		...
		<view class="subjectItem" v-if="sub.subject_name!='科技文艺常识'" v-for="(sub) in subjects" @click="handleSubjectClick" :data-item="sub">
			<view class="img">
				...
				<image v-if="sub.subject_name=='艺术概论'" src="https://art-eater.oss-cn-beijing.aliyuncs.com/photo/%E8%89%BA%E6%9C%AF%E6%A6%82%E8%AE%BA-%E6%A0%87%E9%A2%98%E5%9B%BE1.jpg" mode=""></image>
			</view>
			<view class="progress">
