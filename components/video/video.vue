<template>
	<view class="video-box">
		<video style="width:100vw;" id="myVideo" controls="controls" show-casting-button="true" page-gesture
			play-btn-position="center" enable-play-gesture :object-fit="fill" @loadedmetadata="loadedmetadata"
			@waiting="waiting" @timeupdate="timeupdate" @controlstoggle="controlstoggle"
			@fullscreenclick="fullscreenclick" @fullscreenchange="fullscreenchange" :title="item.vod_name" :src="src">
			<view>
				<!-- 小屏视频自定义控制 -->
				...
				<view v-show="isShowControl" class="flotageY">
					<view @tap="fillTap" style="display: flex;align-items: center;">
						<view :style="fill == 'fill'?'':'transform: rotate(180deg);'"
							style="margin-right: 8rpx; color: #000;font-size: 22rpx;" class="iconfont iconright">

						</view>
						<view :style="fill == 'fill'?'':'transform: rotate(-180deg);'"
							style="color: #000;font-size: 22rpx;" class="iconfont icondown-jiantou-right">
				...
				<view v-show="isShowControl" class="flotageY" style="right: 20rpx;top: 62%;">
					<view @tap="playbackRate" style="display: flex;align-items: center;">
						<view style="opacity: 0.8;font-size: 70rpx;position: relative;color: #000;"
							class="iconfont iconbeisu">
				...
				<view v-show="isShowControl">
					<view class="speed">
						...
						<view @tap="speed('jian')"
							style="color: #000; position: absolute; right: 60%;top: 50%;transform: translate(-50%,-50%);">
							<view class="iconfont iconkuaijin" style="font-size: 70rpx;  transform: rotate(180deg);">

							</view>
						</view>
						<view @tap="speed('jia')" class="iconfont iconkuaijin1"
							style="color: #000;position: absolute; font-size: 80rpx; left: 72%;top: 50%;transform: translate(-50%,-50%);">
		...
		<view v-show="isShowControl" class="flotageY">
			<view @tap="fillTap" style="display: flex;align-items: center;">
				...
				<view :style="fill == 'fill'?'':'transform: rotate(-180deg);'" style="color: #000;font-size: 22rpx;"
					class="iconfont icondown-jiantou-right">
		...
		<view v-show="isShowControl" class="flotageY" style="right: 20rpx;top: 62%;">
			<view @tap="playbackRate" style="display: flex;align-items: center;">
				<view style="opacity: 0.8;font-size: 70rpx;position: relative;color: #000;" class="iconfont iconbeisu">
					<view class="flotageY" style="font-size: 22rpx; right: 13rpx;top: 50%;">
						{{playbackRateList[playbackRateIndex]}}x
					</view>
				</view>
...
<style>
	@font-face {
		...
		src: url('//at.alicdn.com/t/font_2188799_iwu9ledxvl.eot?t=1611736513810');
		/* IE9 */
		src: url('//at.alicdn.com/t/font_2188799_iwu9ledxvl.eot?t=1611736513810#iefix') format('embedded-opentype'),
			...
			url('//at.alicdn.com/t/font_2188799_iwu9ledxvl.svg?t=1611736513810#iconfont') format('svg');
		/* iOS 4.1- */
	}
