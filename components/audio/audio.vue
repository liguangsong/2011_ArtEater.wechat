	...
	<view class="audio-warp" :style="[style]">
		...
		<view class="audio-con">
			<view class="audio-time-info">
				...
				<slider class="audio-slider" :block-size="12" block-color="#D81E1F" activeColor="#D81E1F" :value="value" @changing="_seeking" @change='_seek' />
...
export default {
	...
	methods: {
		...
		_seeking(e) {
			...
			_this.audioTimeUpdate = sToHs(Math.floor((e.detail.value / 100) * _this.innerAudioContext.duration * 1000));
		},
		_seek() {
			_this.audioPlay()
		},
